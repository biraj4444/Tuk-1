...
def seed():
    ...
    if not db.find('zones'):
        zones = [
            {"name":"Pune Central",   "state":"Maharashtra","district":"Pune",
             "base_fare":30,"per_km_rate":12,"per_hour_rate":80,"minimum_fare":50,
             "night_surcharge":1.3,"peak_multiplier":1.5,"emergency_multiplier":1.5,
             "cancellation_pct":10,"active":True},
            {"name":"Mumbai Suburbs", "state":"Maharashtra","district":"Mumbai",
             "base_fare":40,"per_km_rate":15,"per_hour_rate":100,"minimum_fare":60,
             "night_surcharge":1.4,"peak_multiplier":1.6,"emergency_multiplier":2.0,
             "cancellation_pct":10,"active":True},
            {"name":"Nashik City",    "state":"Maharashtra","district":"Nashik",
             "base_fare":25,"per_km_rate":10,"per_hour_rate":70,"minimum_fare":40,
             "night_surcharge":1.2,"peak_multiplier":1.4,"emergency_multiplier":1.5,
             "cancellation_pct":10,"active":True},
            {"name":"Aurangabad",     "state":"Maharashtra","district":"Aurangabad",
             "base_fare":28,"per_km_rate":11,"per_hour_rate":75,"minimum_fare":45,
             "night_surcharge":1.2,"peak_multiplier":1.4,"emergency_multiplier":1.5,
             "cancellation_pct":10,"active":True},
            {"name":"Kolhapur",       "state":"Maharashtra","district":"Kolhapur",
             "base_fare":22,"per_km_rate":9,"per_hour_rate":65,"minimum_fare":35,
